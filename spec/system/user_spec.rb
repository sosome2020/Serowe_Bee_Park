...
before do
FactoryBot.create(:user, name: 'user1', email: 'user1@gmail.com', password: 'password',
user_role: 'Stakeholder', password_confirmation: 'password')
...
test = User.create(name: 'Letebele', email: 'letebele@gmail.com', password: 'password',user_role: 'Farmer', password_confirmation: 'password')
visit user_path(id: test.id)
expect(page).to have_content("Equipments")
end
end
end
...
before do
FactoryBot.create(:admin_user, name: 'admin', email: 'admin@gmail.com', password: 'password', password_confirmation: 'password', user_role: 'Farmer')
visit new_session_path
...
FactoryBot.create(:user, name: 'user1', email: 'user1@gmail.com', password: 'password', password_confirmation: 'password', user_role: 'Farmer')
visit new_session_path
fill_in 'Email', with: 'user1@gmail.com'
fill_in 'Password', with: 'password'
click_button 'Log in'
...
before do
User.create(name: 'Letebele', email: 'letebele@gmail.com', password: 'password', password_confirmation: 'password', user_role: 'Farmer')
@user = User.first
end
...
before do
User.create(name: 'Letebele', email: 'letebele@gmail.com', password: 'password',
password_confirmation: 'password', user_role: 'Farmer')
@user = User.first
end
